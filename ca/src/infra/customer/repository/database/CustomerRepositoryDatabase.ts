...
export class CustomerRepositoryDatabase implements CustomerRepositoryInterface {
    ...
    async findById(id: string): Promise<Customer> {
        ...
        return new Customer(customerResult.id, customerResult.name, new Address(customerResult.street, customerResult.city, customerResult.state, customerResult.zipCode), customerResult.rewardPoints)
    }
